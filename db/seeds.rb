products = [
  ...
  },
  {
    ...
    category: "Cleanser",
    description: "A soft morning cleanser for customers building a gentle routine before serum and moisturizer.",
    price_cents: 2600,
  ...
  },
  {
    ...
    category: "Treatment",
    description: "A concentrated night treatment for customers thinking through usage frequency, texture, and sensitivity.",
    price_cents: 4600,
  ...
  },
  {
    ...
    category: "Toner",
    description: "A daily toner pad set for quick texture care and easy pairing with hydrating serums.",
    price_cents: 2900,
